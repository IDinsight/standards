...
the server is running, run `pnpm run docs:sync-reference` again. Do not edit or
commit generated reference copies.
...
on `main`. No `gh-pages` branch is needed. Commit the docs sources and root pnpm
